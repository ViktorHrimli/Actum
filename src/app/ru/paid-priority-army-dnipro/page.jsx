...
const { API_ARMY_DNIPRO, API_LOCALIZATION } = process.env;

export async function generateMetadata() {
  return await makeSeoTemplate(API_ARMY_DNIPRO, API_LOCALIZATION);
}
...
export default async function PaidArmy() {
  ...
  } = await getStaticLawyersPage(API_ARMY_DNIPRO, API_LOCALIZATION);
