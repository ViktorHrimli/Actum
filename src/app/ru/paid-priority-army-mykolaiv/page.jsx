...
const { API_ARMY_MYKOLAIV, API_LOCALIZATION } = process.env;

export async function generateMetadata() {
  return await makeSeoTemplate(API_ARMY_MYKOLAIV, API_LOCALIZATION);
}
...
export default async function page() {
  ...
  } = await getStaticLawyersPage(API_ARMY_MYKOLAIV, API_LOCALIZATION);
