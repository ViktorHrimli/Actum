...
const { API_CONSULTATION_JURIST, API_LOCALIZATION } = process.env;

export async function generateMetadata() {
  return makeSeoTemplate(API_CONSULTATION_JURIST, API_LOCALIZATION);
}
...
export default async function page() {
  ...
  } = await getStaticLawyersPage(API_CONSULTATION_JURIST, API_LOCALIZATION);
