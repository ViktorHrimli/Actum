    ...
    <section className={styles.section}>
      <div className={styles.container}>
        ...
        <div className={styles.container_text}>
          <p className={styles.title}>ваш запит успішно надіслано, чекайте на вашу віповідь.</p>
          <p className={styles.description}>Ми намагаємося відповідати дуже оперативно, але маємо багато запитів, саме тому будемо вдячні за очікування!</p>
        </div>
        </div>
      </div>
    </section>
