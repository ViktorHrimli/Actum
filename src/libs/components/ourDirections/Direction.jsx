  ...
  return <section className={styles.direction_section} >
    <div className={styles.direction_container}>
      ...
      <div ref={cardsRef} className={styles.mob_img}>
        <div className={styles.mob_img_hands}><div className={styles.mob_img_hands_gradient}></div>
          <Image src={MobHands} alt="Hands" width={290} height={528} className={styles.mob_img_hands} />

          {showCards && <div className={`${!showFirstCard ? styles.show_hands : ''}`}><FamilyMattrs /></div>}
        </div>

        <div className={styles.mob_img_halmet}>
          <Image src={MobHalmet} alt="Halmet" width={290} height={528} className={styles.mob_img_halmet} />

          {showCards && <div className={`${!showSecondCard ? styles.show_halmet : ''}`}><MilitaryMattrs /></div>}
        </div>

        <div className={styles.mob_img_criminal}>
          <Image src={MobCriminal} alt="Halmet" width={290} height={528} className={styles.mob_img_criminal} />

          {showCards && <div className={`${!showThirdCard ? styles.show_criminal : ''}`}><CriminalMattrs /></div>}
        </div>
      </div>
      ...
      <div ref={cardsRef} className={styles.tablet_img}>
        <div className={styles.tablet_img_hands}>
          <Image src={TabletHands} alt="Hands" fill className={styles.tablet_img_hands} />
        ...
        <div className={styles.tablet_img_criminal}>
          <Image src={TabletCriminal} alt="Halmet" fill className={styles.tablet_img_criminal} />
      ...
      <div className={styles.flex_position}>
        <div className={styles.box_img}>
          ...
          <div className={styles.hover_hands} >
            {activeElementIndex === 0 && activeAnimations ? <Image src={Touch_icon} alt="Touch" width={40} height={40} className={styles.touch_icon_hands} /> : ''}
          ...
          <div className={styles.hover_halmet}>
            {activeElementIndex === 1 && activeAnimations ? <Image src={Touch_icon} alt="Touch" width={40} height={40} className={styles.touch_icon_halmet} /> : ''}
          ...
          <div className={styles.hover_criminal}>
            {activeElementIndex === 2 && activeAnimations ? <Image src={Touch_icon} alt="Touch" width={40} height={40} className={styles.touch_icon_criminal} /> : ''}
          ...
          <div className={styles.img_halmet}>
            {activeElementIndex === 1 && activeAnimations ? <Image src={HelmetAnimations} alt="HelmetAnimations" fill className={styles.img} />
              : <Image src={Helmet} alt="Helmet" fill className={styles.img} />}
          </div>
          <div className={styles.img_criminal}>
            <Image src={Criminal} alt="Criminal" fill className={styles.img} />
          </div>
